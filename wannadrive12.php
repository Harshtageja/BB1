...
<br>
<form action="wannadrive13.php" method="post" enctype="multipart/form-data" name="image">
    <label style="font-weight: bolder;margin-left: -5rem">Date:</label>
    <input class="v" type="Date" name="Pickup"style="border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder="From..."required><br><br>
    <label style="font-weight: bolder;margin-left: -5rem">Time:</label>
    <input class="v" type="time" name="Destination"style="border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder="Destination"required><br><br><br><br>
