...
<h1>Dimensions</h1><br>
<br>
<form action="sender4.php" method="post" enctype="multipart/form-data" name="image">
    <label style="font-weight: bolder;margin-left: -2rem">Length in cms</label>
    <input class="v" type="number" name="length"style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder="for eg. 70"required><br><br>
        <label style="font-weight: bolder;margin-left: -2rem">Breadth in cms</label>
    <input class="v" type="number" name="breadth"style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder="for eg. 70"required><br><br>
        <label style="font-weight: bolder;margin-left: -2rem">Height in cms</label>
