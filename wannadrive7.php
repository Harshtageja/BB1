...
<br><br><br>
<form action="wannadrive8.php" method="post" enctype="multipart/form-data" name="image">
   <label for="files" class="btn" style="border: 2px solid black" onclick="this.style.color='white'">Upload Vehicle Photo</label>
