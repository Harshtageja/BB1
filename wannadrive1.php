...
<br><br><br>
<form action="wannadrive2.php" method="post" enctype="multipart/form-data" name="image">
    <label for="files" class="btn" style="border: 2px solid black"onclick="this.style.color='white'">Select License Image</label>
    <input  type="file" id="files" name="image"style="width: 50%;border: none;background-color:#DCDCDC;margin-left:;border-radius: 15px;padding-left: 10px;" placeholder="Upload License" required><br><br>
     <input class="v" type="text" name="LicenseNumber"style="border: none;font-size;background-color:#DCDCDC;margin-left:;border-radius: 15px;padding-left: 10px;" placeholder="Your License Number" required=""><br><br>
