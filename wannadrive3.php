...
<br><br><br>
<form action="wannadrive4.php" method="post" enctype="multipart/form-data" name="image">
   <label for="files" class="btn" style="border: 2px solid black" onclick="this.style.color='white'">Upload RC Image</label>
    <input class="v" type="file" id="files" name="image"style="width: 50%;border: none;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder="Upload License"required><br><br><br><br>
