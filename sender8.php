...
<h1>Address</h1><br>
<br>
<form action="sender9.php" method="post" enctype="multipart/form-data" name="image">
    <label style="font-weight: bolder;margin-left: -2rem">From</label>
    <input class="v" type="int" name="pickup"style="width: 50%;border: none;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder=" #455 dash colony,Mumbai"required><br><br>
        <label style="font-weight: bolder;margin-left: -2rem">To</label>
    <input class="v" type="int" name="dest"style="width: 50%;border: none;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder=" #455 dash colony,Mumbai"required><br><br>
