...
<br><br><br>
<form action="sender6.php" method="post" enctype="multipart/form-data" name="image">
    <label for="files" class="btn" style="border: 2px solid black"onclick="this.style.color='white'">Upload adhaar front side</label>
    <input class="v" id="files" type="file" name="image"style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder="Upload License"required><br><br><br><br>
